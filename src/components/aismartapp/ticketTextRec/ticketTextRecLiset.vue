...
export default {
  ...
  data () {
    return {
      objText:{
        title:'票据文字识别',
        title_desc:'基于业界领先的深度学习技术，提供对财税报销、金融保险等场景所涉及的各类票据进行结构化识别的服务',
        use_btn:'立即使用',
        tech_file:'技术文档',
        listType:'ticketTextRecLiset',
        list_img:require('@/assets/images/aiSmartAppList/piaojuBanner.png'),
        funText:'即刻获得票据文字识别能力',
        product_list_data:[
            {
              img:require('@/assets/images/aiSmartAppList/zengzhishuifapiao_shibie.png'),
              title:'增值税发票识别',
              desc:'对增值税普票、专票、电子发票所有30个字段进行结构化识别',
              path:'/ticketTextRecDetail'
            },
            {
              img:require('@/assets/images/aiSmartAppList/yinhanghuipiao_shibie.png'),
              title:'银行汇票识别',
              desc:'对收/付款人账号、出票金额、出票日期、承兑人信息等21个关键字段进行结构化识别',
              path:''
            }
        ],
        menu_text:['财务报销','保险核保','发票审核','账单记录'],
        weitu:require('../../../assets/images/aiSmartAppList/piaojuWeitu.png'),
        app_title:'财务报销',
        app_desc:'用于报销环节将各类发票上的财务所需字段结构化输出，方便信息存储和审核，减少人工成本',
        advant_text:[
            {
                img:require('../../../assets/images/aiSmartAppList/advant.png'),
                title:'字段齐全',
                desc:'支持对常用票据的所有字段结构化识别，信息丰富，能够满足各类业务场景需求，可供开发者灵活选择'
            },
            {
                img:require('../../../assets/images/aiSmartAppList/advant.png'),
                title:'技术领先',
                desc:'针对各类票据特定的字体、打印样式进行优化，综合场景下字段准确率高达98%，其中增值税发票、出租车票四要素准确率高达99.9%'
            },
            {
                img:require('../../../assets/images/aiSmartAppList/advant.png'),
                title:'服务稳定',

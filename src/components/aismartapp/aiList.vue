  ...
  <div class="aiSyntax" v-if="result">
    ...
    <div class="featur_function_container">
      <div class="featur_function" ref="proList">
        <div class="title listDom" id="1">产品列表</div>
        <div class="component">
          <iconStyle1 :num="result.listRowCount" :imgbaseUrl="result.imageAddress" :textImg="result.pageProductList"></iconStyle1>
        </div>
      </div>
    </div>
...
import iconStyle1 from "../common/iconStyle1";

<template>
  <div class="elevation_info_container">
      <div class="menu_container">
          <div class="menu">
              <span>地理信息综合查询</span><span> > 海拔信息</span>
          </div>
      </div>
      <div class="title">海拔信息</div>
            ...
            that.$axios({
                ...
                if(res.status == 200 ){
                    ...
                    if(item.name==params.name){
                        that.$axios({
                            method: "get",
                            url:window.config.url+'/static/mapJson/'+item.areaCode+".geoJson",
                        }).then(res=>{
